// 20.3
/* Progettare una funzione iterativa
che cerchi un elemento in un albero binario di ricerca
* 
* SUGGERIMENTO: il METODO: void E(char, nodo* &); cerca nodo da eliminare
*/
