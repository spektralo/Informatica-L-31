...
int main(){
    ...
    printf("\ny=%.15g", y); // notazione esponenziale. Se specificato g, allora la precisione si riferira' al numero di cifre significative da stampare
