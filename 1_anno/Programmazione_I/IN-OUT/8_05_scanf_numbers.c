...
int main(){
    ...
    printf("\n Inserisci un intero di max 3 caratteri (NB: il numero di caratteri include eventuale segno!): ");
    ...
    printf("\n Inserisci un float, un double ed un intero separati da spazi: ");

    scanf("%f %lf %d",&unfloat, &undouble, &unintero); // usa il modificatore di ampiezza di campo 
